    ...
    return (
      <Row className={styles.CQSSC}>
        ...
        <Row className={styles.content}>
          ...
          <Col span={24}>
            {'2. 五星直选：选5个号码，与开奖号码完全相同且顺序一致，100000元'}
          </Col>
          <Col span={24}>
            {'3. 五星通选：选5个号码，与开奖号码完全按位相符 20000元'}
          </Col>
          <Col span={24}>
            {'4. 五星通选2：选5个号码，与开奖号码前三位或后三位按位相符 200元'}
          </Col>
          <Col span={24}>
            {'5. 五星通选3：选5个号码，与开奖号码前二位或后二位按位相符 20元'}
          </Col>
          <Col span={24}>
            {'6. 三星直选：选3个号码，与开奖号码连续后三位按位相符 1000元'}
          </Col>
          <Col span={24}>
            {'7. 三星组六：选3个号码，投注号与开奖号后三位相同且为组六，顺序不限，组六：开奖号码后三位三个号码各不相同，如135，160元'}
          </Col>
          <Col span={24}>
            {'8. 二星直选：选2个号码，与开奖号码连续后二位按位相符，100元'}
          </Col>
          <Col span={24}>
            {'9. 二星组选：选2个号码，与开奖号码连续后二位相符，50元'}
          </Col>
          <Col span={24}>
            {'10. 一星直选，选1个号码，与开奖号码个位相符，10元'}
          </Col>
          <Col span={24}>
            {'11. 大小单双：与开奖号码后两位数字属性按位相符，4元'}
          </Col>
          <Col span={24}>
